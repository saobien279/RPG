...
UIData.SKILL_INFO = {
    -- [EXTRA SKILLS - COMMON/UNCOMMON]
    ["Sticky Thread"] = { Rarity = "Common", Desc = "Bind targets.", Buff = "+3 Dex" },
    ["Body Armor"] = { Rarity = "Common", Desc = "Magical armor.", Buff = "+5 Defense" },
    ["Magic Sense"] = { Rarity = "Common", Desc = "Perceive magicules.", Buff = "+4 Arcane" },
    ["Black Lightning"] = { Rarity = "Uncommon", Desc = "Dark lightning.", Buff = "+10 Arcane" },
    ["Shadow Motion"] = { Rarity = "Uncommon", Desc = "Move in shadows.", Buff = "+8 Dex" },
    ["Herculean Strength"] = { Rarity = "Uncommon", Desc = "Physical strength.", Buff = "+12 Str" },
    ["Water Blade"] = { Rarity = "Uncommon", Desc = "Water cutter.", Buff = "+5 Arcane" },

    -- [UNIQUE SKILLS - RARE/EPIC/LEGENDARY]
    ["Berserker"] = { Rarity = "Rare", Desc = "Berserk mode.", Buff = "+15 Str, -5 Def" },
    ["Survivor"] = { Rarity = "Rare", Desc = "Never give up.", Buff = "+20 Regen" },
    ["Severer"] = { Rarity = "Rare", Desc = "Cut space.", Buff = "+15 Crit" },
    ["Degenerate"] = { Rarity = "Epic", Desc = "Synthesis.", Buff = "+5 All Stats" },
    ["Mathematician"] = { Rarity = "Epic", Desc = "Fast Calc.", Buff = "+20 Arcane" },
    ["Starved"] = { Rarity = "Epic", Desc = "Eat all.", Buff = "15% Lifesteal" },
    ["Predator"] = { Rarity = "Legendary", Desc = "Predation.", Buff = "Absorb Skills" },
    ["Great Sage"] = { Rarity = "Legendary", Desc = "AI Assistant.", Buff = "Auto-Battle, +50% Exp" },
    ["Gluttony"] = { Rarity = "Legendary", Desc = "Gluttony.", Buff = "AoE Absorb" },
